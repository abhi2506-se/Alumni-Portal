...
<title>Manage Account | Alumni Aravali College of Engineering & Management</title>
<style>
    .masthead{
                                    ...
                                    <form action="" id="update_account">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="lastname" value="<?php echo $_SESSION['bio']['lastname'] ?>" >
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-md-4">
